...
// TODO: to enable fifo only let reader thread switch the lanes
// TODO: another idea for unbounded fifo queue is a LF doubly linked list of dynamically allocated lanes (with a free list)
template<typename T>
class LFSPSCQueue {
