...
{
    // code that deals with indexes wrapping the underlying array breaks if the size is not multiple of HOLY_GRAIL_SIZE
    if (maxElements%HOLY_GRAIL_SIZE)
        maxElements = ((maxElements / HOLY_GRAIL_SIZE) + 1)*HOLY_GRAIL_SIZE;
